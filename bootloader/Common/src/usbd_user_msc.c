...
const char mbr[] = {
    ...
    0x02, /* number of FATs*/ 0x20,0x00, /*Maximum number of root directory entries: 32*/ 0x00,0x02, /*Total sector count: 1024*/ 0xF0,  0x01,0x00,/*sectors per FAT: 1*/  0x01,0x00,/*Sectors per track*/  0x01,0x00, /*Number of heads*/  0x00,0x00,0x00,0x00,
...
const char fat1[] = {
    0xF0, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
};

const char fat2[] = {0};

const char fail[] = {   'F', 'A', 'I', 'L', 0x20, 0x20, 0x20, 0x20, 'T', 'X', 'T', 0x20, 0x18, 0xB1, 0x74, 0x76,
                        0x8E, 0x41, 0x8E, 0x41, 0x0, 0x0, 0x8E, 0x76, 0x8E, 0x41, 0x4, 0x0, 0x7, 0x0, 0x0, 0x0};

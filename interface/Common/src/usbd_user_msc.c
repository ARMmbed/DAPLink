...
const unsigned char DiskImage[0x1000] = {
0xEB,0x3C,0x90,0x4D,0x53,0x44,0x4F,0x53,0x35,0x2E,0x30,0x00,0x02,0x01,0x01,0x00,
0x01,0x10,0x00,0x20,0x00,0xF8,0x02,0x00,0x01,0x00,0x01,0x00,0x00,0x00,0x00,0x00,
0x00,0x00,0x00,0x00,0x00,0x00,0x29,0x74,0x19,0x02,0x27, 'L', 'P', 'C', '1', '7',
 'x', 'x', ' ', 'U', 'S', 'B',0x46,0x41,0x54,0x31,0x32,0x20,0x20,0x20,0x33,0xC9,
...
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
 'L', 'P', 'C', '1', '7', 'x', 'x', ' ', 'U', 'S', 'B',0x28,0x00,0x00,0x00,0x00,
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
...
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
 'T', 'h', 'i', 's', ' ', 'i', 's', ' ', 'a', ' ', 'U', 'S', 'B', ' ', 'M', 'e',
 'm', 'o', 'r', 'y', ' ', 'D', 'e', 'v', 'i', 'c', 'e', ' ', 'D', 'e', 'm', 'o',
 'n', 's', 't', 'r', 'a', 't', 'i', 'o', 'n', ' ', 'f', 'o', 'r','\r','\n', 't',
 'h', 'e', ' ', 'K', 'e', 'i', 'l', ' ', 'M', 'C', 'B', '1', '7', '0', '0', ' ',
 'B', 'o', 'a', 'r', 'd', ' ', 'w', 'i', 't', 'h', ' ', 'N', 'X', 'P', ' ', 'L',
 'P', 'C', '1', '7', 'x', 'x', '.',0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
...
static const mbr_t mbr = {
    ...
    .total_logical_sectors    = 32, //((MBR_NUM_NEEDED_SECTORS > 32768) ? 0 : MBR_NUM_NEEDED_SECTORS),
    .media_descriptor         = 0xF8,
    .logical_sectors_per_fat  = 2, /* Need 3 sectors/FAT for every 1024 clusters */
    ...
    .volume_label = {'m','b','e','d',' ','d','n','d','u','s','b'},
...
void usbd_msc_read_sect (U32 block, U8 *buf, U32 num_of_blocks) {
    if (USBD_MSC_MediaReady) {
        if ((block * USBD_MSC_BlockSize) < sizeof(DiskImage)) {
            memcpy(buf, &DiskImage[block * USBD_MSC_BlockSize], num_of_blocks * USBD_MSC_BlockSize);
        }
        else {
            memset(buf, 0, USBD_MSC_BlockSize);
        }
    }
}

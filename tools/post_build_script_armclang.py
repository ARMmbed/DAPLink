...
subprocess.call(['fromelf', '--bincombined', os.path.join(project_dir, project_name + '.axf'),
                 '--output', os.path.join(project_dir, 'firmware.bin')])
subprocess.call(['fromelf', '--i32combined', os.path.join(project_dir, project_name + '.axf'),
                 '--output', os.path.join(project_dir, 'firmware.hex')])

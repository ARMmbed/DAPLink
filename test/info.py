...
SUPPORTED_CONFIGURATIONS = [
    ...
    (   0x200,      0x12,       'k20dx_frdmkl25z_if',                       'k20dx_bl',         'KL25Z'                                 ),
    (   0x203,      0x12,       'k20dx_twrkl28z72m_if',                     'k20dx_bl',         None                                    ),
    (   0x204,      0x12,       'k20dx_frdmkl02z_if',                       'k20dx_bl',         None                                    ),
    (   0x205,      0x12,       'k20dx_frdmkl28z_if',                       'k20dx_bl',         None                                    ),
    (   0x206,      0x11,       'k20dx_twrke18f_if',                        'k20dx_bl',         None                                    ),
    (   0x210,      0x12,       'k20dx_frdmkl05z_if',                       'k20dx_bl',         'FRDM-KL05Z'                            ),
    (   0x213,      0x12,       'k20dx_frdmke15z_if',                       'k20dx_bl',         None                                    ),
    (   0x216,      0x11,       'k20dx_hvpke18f_if',                        'k20dx_bl',         None                                    ),
    (   0x217,      0x11,       'k20dx_frdmk82f_if',                        'k20dx_bl',         'FRDM-K82F'                             ),
    (   0x220,      0x12,       'k20dx_frdmkl46z_if',                       'k20dx_bl',         'FRDM-KL46Z'                            ),
    (   0x224,      0x11,       'k20dx_frdmk28f_if',                        'k20dx_bl',         None                                    ), # TODO - set target to 'FRDM-K28F' when mbed-os supports this
    (   0x226,      0x13,       'k20dx_mimxrt1020_evk_qspi_if',             'k20dx_bl',         None                                    ), # TODO - set target to 'MIMX6RT1050' when mbed-os supports this
    (   0x227,      0x13,       'k20dx_mimxrt1050_evk_hyper_if',            'k20dx_bl',         None                                    ), # TODO - set target to 'MIMX6RT1050' when mbed-os supports this
    (   0x227,      0x13,       'k20dx_mimxrt1050_evk_qspi_if',             'k20dx_bl',         None                                    ), # TODO - set target to 'MIMX6RT1050' when mbed-os supports this
    (   0x230,      0x11,       'k20dx_frdmk20dx_if',                       'k20dx_bl',         'FRDM-K20D50M'                          ),
    (   0x231,      0x11,       'k20dx_frdmk22f_if',                        'k20dx_bl',         'FRDM-K22F'                             ),
    (   0x240,      0x11,       'k20dx_frdmk64f_if',                        'k20dx_bl',         'FRDM-K64F'                             ),
    (   0x214,      0x14,       'k20dx_hexiwear_if',                        'k20dx_bl',         'HEXIWEAR'                              ),
    (   0x228,      0x14,       'k20dx_rapid_iot_if',                       'k20dx_bl',         None                                    ), # TODO - set target to 'Rapid-IoT' when mbed-os supports this
    (   0x260,      0x12,       'k20dx_frdmkl26z_if',                       'k20dx_bl',         None                                    ),
    (   0x261,      0x12,       'k20dx_frdmkl27z_if',                       'k20dx_bl',         'FRDM-KL27Z'                            ),
    (   0x262,      0x12,       'k20dx_frdmkl43z_if',                       'k20dx_bl',         'FRDM-KL43Z'                            ),
    (   0x250,      0x11,       'k20dx_frdmkw24d_if',                       'k20dx_bl',         'FRDM-KW24D512'                         ),
    (   0x201,      0x12,       'k20dx_frdmkw41z_if',                       'k20dx_bl',         'FRDM-KW41Z'                            ),
    ...
    (   0x0454,     0x01,       'lpc11u35_mtb_mts_dragonfly_if',            None,               None                                    ),
    (   0x0455,     0x22,       'lpc11u35_mtb_nina_b112_if',                None,               None                                    ), # TODO - set target when mbed-os supports this
    (   0x0456,     0x01,       'lpc11u35_mtb_murata_abz_078_if',           None,               None                                    ), # TODO - set target when mbed-os supports this
    (   0x0457,     0x01,       'lpc11u35_mtb_rak811_if',                   None,               None                                    ), # TODO - set target when mbed-os supports this
    (   0x458,      0x01,       'lpc11u35_mtb_wise1510_if',                 None,               None                                    ), # TODO - set target when mbed-os supports this
    (   0x459,      0x01,       'lpc11u35_mtb_wise1530_if',                 None,               None                                    ), # TODO - set target when mbed-os supports this
    (   0x460,      0x01,       'lpc11u35_mtb_wise1570_if',                 None,               None                                    ), # TODO - set target when mbed-os supports this
    (   0x0461,     0x22,       'lpc11u35_mtb_laird_bl652_if',              None,               None                                    ), # TODO - set target when mbed-os supports this
    (   0x0462,     0x01,       'lpc11u35_mtb_usi_wm_bn_bm_22_if',          None,               None                                    ), # TODO - set target when mbed-os supports this
    ...
    (   0x720,      0x01,       'stm32f103xb_stm32f401re_if',               'stm32f103xb_bl',   'ST-Nucleo-F401RE'                      ),
    (   0x720,      0x01,       'stm32f103xb_stm32f072rb_if',               'stm32f103xb_bl',   'ST-Nucleo-F072RB'                      ),
    (   0x735,      0x01,       'stm32f103xb_stm32f334r8_if',               'stm32f103xb_bl',   'ST-Nucleo-F334R8'                      ),
    (   0x740,      0x01,       'stm32f103xb_stm32f411re_if',               'stm32f103xb_bl',   'ST-Nucleo-F411RE'                      ),
    ...
    (   0x1018,     0x01,       'lpc11u35_ssci824_if',                      None,               'Switch-Science-mbed-LPC824'            ),
    (   0x1019,     0x21,       'lpc11u35_sscity_if',                       None,               'Switch-Science-mbed-TY51822r3'         ),
    (   0x1022,     0x01,       'lpc11u35_ro359b_if',                       None,               None                                    ),
    (   0x1050,     0x01,       'lpc11u35_lpc812xpresso_if',                None,               'NXP-LPC800-MAX'                        ),
    (   0x1054,     0x01,       'lpc4322_lpc54114xpresso_if',               'lpc4322_bl',       'LPCXpresso54114'                       ),
    (   0x1056,     0x01,       'lpc4322_lpc54608xpresso_if',               'lpc4322_bl',       'LPCXpresso54608'                       ),
    (   0x0236,     0x01,       'lpc4322_lpc55s69xpresso_if',               'lpc4322_bl',       'LPCXpresso55S69'                       ),
    (   0x1060,     0x00,       'lpc11u35_lpc4088qsb_if',                   None,               'EA-LPC4088'                            ),
    (   0x1062,     0x00,       'lpc11u35_lpc4088dm_if',                    None,               'EA-LPC4088-Display-Module'             ),
    (   0x1070,     0x21,       'sam3u2c_mkit_dk_dongle_nrf5x_if',          'sam3u2c_bl',       'Nordic-nRF51822'                       ),
    (   0x1090,     0x21,       'k20dx_rbl_if',                             'k20dx_bl',         'RedBearLab-nRF51822'                   ),
    (   0x1095,     0x21,       'k20dx_rblnano_if',                         'k20dx_bl',         'RedBearLab-BLE-Nano'                   ),
    (   0x1100,     0x21,       'sam3u2c_mkit_dk_dongle_nrf5x_if',          'sam3u2c_bl',       'Nordic-nRF51-DK'                       ),
    (   0x1101,     0x22,       'sam3u2c_mkit_dk_dongle_nrf5x_if',          'sam3u2c_bl',       'Nordic-nRF52-DK'                       ),
    (   0x1102,     0x22,       'sam3u2c_mkit_dk_dongle_nrf5x_if',          'sam3u2c_bl',       'Nordic-nRF52840-DK'                    ),
    (   0x1021,     0x21,       'lpc11u35_ssci_chibi_if',                   None,               None                                    ), # TODO - set target to 'SSCI-MBIT' when mbed-os supports this
    (   0x1114,     0x01,       'lpc11u35_ssci1114_if',                     None,               'LPC1114FN28'                           ),
    (   0x1120,     0x21,       'sam3u2c_mkit_dk_dongle_nrf5x_if',          'sam3u2c_bl',       'Nordic-nRF51-Dongle'                   ),
    (   0x1234,     0x01,       'lpc11u35_c027_if',                         None,               'u-blox-C027'                           ),
    (   0x1200,     0x03,       'sam3u2c_ncs36510rf_if',                   'sam3u2c_bl',        None                                    ),# TODO - Set to 'ncs36510' when non-zero flash addresses are supported
    (   0x1236,     0x01,       'stm32f103xb_ublox_evk_odin_w2_if',        'stm32f103xb_bl',    'ublox-EVK-ODIN-W2'                     ),
    (   0x1238,     0x21,       'kl26z_nina_b1_if',                        'kl26z_bl',          'u-blox-NINA-B1'                        ),
    (   0x2410,     0x01,       'lpc11u35_mbed_cloud_connect_if',           None,               None                                    ),
    (   0x4600,     0x31,       'lpc11u35_rtl8195am_if',                    None,               'REALTEK-RTL8195AM'                     ),
    (   0x5050,     0x01,       'lpc11u35_arm_watch_stm32f411_if',          None,               None                                    ),
    (   0x5051,     0x03,       'lpc11u35_arm_watch_efm32_if',              None,               None                                    ),
    (   0x5052,     0x21,       'lpc11u35_arm_watch_nrf51_if',              None,               None                                    ),
    (   0x7010,     0x51,       'lpc11u35_blueninja_if',                    None,               None                                    ), # TODO - set target to 'BlueNinja-CDP-TZ01B' when mbed-os supports this
    (   0x9004,     0x01,       'lpc11u35_archpro_if',                      None,               'Seeeduino-Arch-Pro'                    ),
    (   0x9009,     0x21,       'lpc11u35_archble_if',                      None,               'Seeed-Arch-BLE'                        ),
    ...
    (   0x7402,     0x11,       'lpc11u35_6lowpan_borderrouterhat_if',      None,               'mbed-6LoWPAN-Border-Router-HAT'        ),
    (   0x7403,     0x11,       'lpc11u35_6lowpan_borderrouterusb_if',      None,               'mbed-6LoWPAN-Border-Router-USB'        ),
    (   0x7404,     0x11,       'lpc11u35_6lowpan_borderrouterethernet_if', None,               'mbed-6LoWPAN-Border-Router-ETHERNET'   ),
    (   0xC000,     0x01,       'lpc11u35_cocorico_if',                     None,               'CoCo-ri-Co'                            ),
    (   0x5500,     0x01,       'lpc11u35_gr_peach_if',                     None,               None                                    ), # TODO - Set to 'Renesas-GR-PEACH' once this target builds
    (   0x5501,     0x01,       'lpc11u35_gr_lychee_if',                    None,               None                                    ), # TODO - Set to 'Renesas-GR-LYCHEE' once this target builds
    (   0x6660,     0x01,       'lpc11u35_nz32_sc151_if',                   None,               None                                    ), # TODO - set target to 'NZ32-SC151' when mbed-os supports this
    (   0x2201,     0x61,       'lpc11u35_wizwiki_w7500_if',                None,               'WIZwiki-W7500'                         ),
    (   0x2202,     0x61,       'lpc11u35_wizwiki_w7500_eco_if',            None,               'WIZwiki-W7500ECO'                      ),
    (   0x2203,     0x61,       'lpc11u35_wizwiki_w7500p_if',               None,               'WIZwiki-W7500P'                        ),
    (   0x1237,     0x22,       'sam3u2c_ublox_evk_nina_b1_if',            'sam3u2c_bl',        'U-BLOX-EVK-NINA-B1'                    ),
    (   0xC006,     0x21,       'lpc11u35_vbluno51_if',                     None,               'VBLUNO51'                              ),
    (   0xC005,     0x21,       'lpc11u35_mtconnect04s_if',                 None,               'MtConnect04S'                          ),
    (   0x3104,     0x22,       'lpc11u35_dipdap_sdt52832b_if',             None,               None                                    ),
    (   0x3108,     0x01,       'lpc11u35_dipdap_sdt32429b_if',             None,               None                                    ),
    (   0x3110,     0x01,       'lpc11u35_dipdap_sdt32439b_if',             None,               None                                    ),
    (   0x3105,     0x11,       'lpc11u35_dipdap_sdt64b_if',                None,               None                                    ),
    (   0x3103,     0x21,       'lpc11u35_dipdap_sdt51822b_if',             None,               None                                    ),
    (   0x3300,     0x41,       'lpc11u35_dipdap_cc3220sf_if',              None,               'CC3220SF'                              ),
]

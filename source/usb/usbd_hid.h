...
extern void USBD_HID_SPOOF_EP_INTIN_Event(U32 event);
extern void USBD_HID_SPOOF_EP_INTOUT_Event(U32 event);
extern void USBD_HID_SPOOF_EP_INT_Event(U32 event);

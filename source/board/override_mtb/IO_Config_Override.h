 ...
 * @brief   Alternative IO for LPC11U35 based Hardware Interface Circuit for all 6LoWPAN_BorderRouter, Moved SWCLK
 *
...
// SWO/TDO Pin                          PIO0_010
#define PIN_TDO_PORT                    0
#define PIN_TDO_BIT                     10
#define PIN_TDO                         (1 << PIN_TDO_BIT)
#define PIN_TDO_IOCON                   LPC_IOCON->PIO0_010

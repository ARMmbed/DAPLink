...
__attribute__((aligned(4)))
const vfs_filename_t daplink_drive_name =     "FF-LPC546XX";
__attribute__((aligned(4)))
const char *const daplink_target_url = "https://os.mbed.com/platforms/L-TEK-FF-LPC546XX";

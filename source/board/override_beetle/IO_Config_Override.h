...
// SWCLK/TCK Pin                        PIO0_8              -DIFFERS FROM STANDARD PINOUT
#define PIN_SWCLK_PORT                  0
#define PIN_SWCLK_BIT                   8
#define PIN_SWCLK                       (1 << PIN_SWCLK_BIT)
#define PIN_SWCLK_TCK_IOCON             LPC_IOCON->PIO0_8
#define PIN_SWCLK_TCK_IOCON_INIT        (FUNC_0 | PULL_UP_ENABLED)

// SWDIO/TMS In/Out Pin                 PIO0_7              -DIFFERS FROM STANDARD PINOUT
#define PIN_SWDIO_PORT                  0
#define PIN_SWDIO_BIT                   7
#define PIN_SWDIO                       (1 << PIN_SWDIO_BIT)
#define PIN_SWDIO_TMS_IOCON             LPC_IOCON->PIO0_7
...
#define PIN_TDI_IOCON                   LPC_IOCON->PIO0_20

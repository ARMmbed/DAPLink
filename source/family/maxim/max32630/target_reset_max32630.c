/**
 * @file    target_reset.c
 * @brief   Target reset for the MAX32630
 *
 ...
 */
static uint8_t target_set_state_max32630(target_state_t state)
{
...
const target_family_descriptor_t g_maxim_max32630 = {
    .family_id = kMaxim_MAX32630_FamilyID,
    .target_set_state = target_set_state_max32630,

...
void USBD_ResetEP(U32 EPNum)
{
    ...
    u32Num = EPNum & 0x0F;
    u32Ep = USBD_NUM_TO_EP(u32Num);
    HSUSBD->EP[u32Ep].EPRSPCTL = HSUSBD->EP[u32Ep].EPRSPCTL | HSUSBD_EPRSPCTL_FLUSH_Msk;
}
...
U32 USBD_WriteEP(U32 EPNum, U8 *pData, U32 cnt)
{
    ...
    if (u32Num == 0) {
        ...
        if (cnt > 0) {
            ...
            HSUSBD->EP[u32Ep].EPRSPCTL = HSUSBD_EP_RSPCTL_SHORTTXEN;
        } else {
            HSUSBD->EP[u32Ep].EPRSPCTL = HSUSBD_EP_RSPCTL_ZEROLEN;
        }

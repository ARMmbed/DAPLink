...
#define USBD_HID_SPOOF_STRDESC      L"WebUSB: CMSIS-DAP"
...
#define USBD_WINUSB_IF_NUM          USBD_HID_SPOOF_IF_NUM
//   </e>
// </e>
...
#define USBD_IF_NUM                (USBD_HID_SPOOF_ENABLE+USBD_HID_ENABLE+USBD_MSC_ENABLE+(USBD_ADC_ENABLE*2)+(USBD_CDC_ACM_ENABLE*2)+USBD_CLS_ENABLE+USBD_DFU_ENABLE)
#define USBD_MULTI_IF              (USBD_CDC_ACM_ENABLE*(USBD_HID_ENABLE|USBD_MSC_ENABLE|USBD_ADC_ENABLE|USBD_CLS_ENABLE|USBD_DFU_ENABLE|USBD_HID_SPOOF_ENABLE))
...
#define USBD_HID_SPOOF_IF_NUM      (USBD_ADC_ENABLE*2+USBD_MSC_ENABLE*1+USBD_CDC_ACM_ENABLE*2+USBD_HID_ENABLE)
#define USBD_DFU_IF_NUM            (USBD_ADC_ENABLE*2+USBD_MSC_ENABLE*1+USBD_CDC_ACM_ENABLE*2+USBD_HID_ENABLE*2)
...
#define USBD_HID_SPOOF_IF_STR_NUM  (3+USBD_STRDESC_SER_ENABLE+USBD_ADC_ENABLE*3+USBD_CDC_ACM_ENABLE*2+USBD_HID_ENABLE)
#define USBD_MSC_IF_STR_NUM        (3+USBD_STRDESC_SER_ENABLE+USBD_ADC_ENABLE*3+USBD_CDC_ACM_ENABLE*2+USBD_HID_ENABLE+USBD_HID_SPOOF_ENABLE)
#define USBD_DFU_IF_STR_NUM        (3+USBD_STRDESC_SER_ENABLE+USBD_ADC_ENABLE*3+USBD_CDC_ACM_ENABLE*2+USBD_HID_ENABLE+USBD_HID_SPOOF_ENABLE+USBD_MSC_ENABLE)

...
#include "pre_stm32f1.h"

#define DAPLINK_ROM_START               STM32F1_ROM_START
#define DAPLINK_ROM_SIZE                STM32F1_ROM_SIZE

#define DAPLINK_RAM_START               STM32F1_RAM_START
#define DAPLINK_RAM_SIZE                STM32F1_RAM_SIZE
...
#define DAPLINK_SECTOR_SIZE             STM32F1_SECTOR_SIZE

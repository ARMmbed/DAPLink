...
#define DAPLINK_ROM_BL_SIZE             0x00009800

#define DAPLINK_ROM_CONFIG_ADMIN_START  0x08009800
#define DAPLINK_ROM_CONFIG_ADMIN_SIZE   0x00000800

#define DAPLINK_ROM_IF_START            0x0800A000
#define DAPLINK_ROM_IF_SIZE             0x00075000

#define DAPLINK_ROM_CONFIG_USER_START   0x0807F000
#define DAPLINK_ROM_CONFIG_USER_SIZE    0x00001000

/* RAM sizes */

#define DAPLINK_RAM_APP_START           0x20000000
#define DAPLINK_RAM_APP_SIZE            0x00014000

#define DAPLINK_RAM_SHARED_START        0x20014000
#define DAPLINK_RAM_SHARED_SIZE         0x00004000

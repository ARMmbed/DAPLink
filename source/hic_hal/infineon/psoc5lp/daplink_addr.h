...
#define DAPLINK_ROM_START               0x00019800
#define DAPLINK_ROM_SIZE                0x00026600

#define DAPLINK_RAM_START               0x1FFF8000
#define DAPLINK_RAM_SIZE                0x00010000


/* ROM sizes */

#define DAPLINK_ROM_BL_START            0x00019800
#define DAPLINK_ROM_BL_SIZE             0x00000000

#define DAPLINK_ROM_CONFIG_ADMIN_START  0x00019800
#define DAPLINK_ROM_CONFIG_ADMIN_SIZE   0x00000000

// For custom app start addr should be  0x00021800
#define DAPLINK_ROM_IF_START            0x00019800
#define DAPLINK_ROM_IF_SIZE             0x00026500

#define DAPLINK_ROM_CONFIG_USER_START   0x0003FD00

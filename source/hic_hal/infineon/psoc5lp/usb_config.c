/*******************************************************************************
* @file    usb_config.h
* @brief   USB configuration contants
*
********************************************************************************
...
#define USBD_CFGDESC_BMAXPOWER      0xC8
...
#define USBD_MSC_EP_BULKIN          6
#define USBD_MSC_EP_BULKOUT         7

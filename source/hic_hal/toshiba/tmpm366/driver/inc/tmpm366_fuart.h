...
#ifndef __TMPM366_FUART_H
#define __TMPM366_FUART_H
  ...
  */
    ...
    typedef struct {
        ...
        uint32_t Parity;        /*!< Specifies the parity mode which could be  0 parity,
                                   1 parity, odd arity, even parity or no parity. */
...
/** @defgroup FUART_Exported_Constants
  * @{
  */
#define TSB_FUART0                             TSB_UART
#define FUART0                                 TSB_FUART0
#define TSB_FUART_TypeDef                      TSB_UART_TypeDef

#define IS_FUART_PERIPH(param)                 ((param) == FUART0)

#define IS_FUART_DMA_PERIPH(param)             ((param) == FUART0)

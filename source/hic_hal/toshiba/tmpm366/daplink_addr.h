...
#define DAPLINK_RAM_SIZE                0x0000C000

// ROM sizes
#define DAPLINK_ROM_BL_START            0x00000000
#define DAPLINK_ROM_BL_SIZE             0x00008C00

#define DAPLINK_ROM_CONFIG_ADMIN_START  0x00008C00
#define DAPLINK_ROM_CONFIG_ADMIN_SIZE   0x00000400

#define DAPLINK_ROM_IF_START            0x00009000
#define DAPLINK_ROM_IF_SIZE             0x00017000

#define DAPLINK_ROM_CONFIG_USER_START   0x00020000
#define DAPLINK_ROM_CONFIG_USER_SIZE    0x00020000

// RAM sizes
#define DAPLINK_RAM_APP_START           0x20000000
#define DAPLINK_RAM_APP_SIZE            0x00009000

#define DAPLINK_RAM_SHARED_START        0x20009000
#define DAPLINK_RAM_SHARED_SIZE         0x00003000

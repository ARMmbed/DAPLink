...
COMPILER_ASSERT(GPIO_CHECK_PRESENT_NRF52840(UART_RX_PIN));
COMPILER_ASSERT(GPIO_CHECK_PRESENT_NRF52840(UART_TX_PIN));
COMPILER_ASSERT(GPIO_CHECK_PRESENT_NRF52840(RESET_BUTTON));

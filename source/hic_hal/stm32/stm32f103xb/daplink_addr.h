...
#define DAPLINK_ROM_BL_SIZE             0x00004000
#else
#define DAPLINK_ROM_BL_START            0x08000000
...
#ifdef  STLINK_V2_1_BOOTLOADER
#define DAPLINK_ROM_CONFIG_ADMIN_START  0x08004000
#define DAPLINK_ROM_CONFIG_ADMIN_SIZE   0x00000000
#else
#define DAPLINK_ROM_CONFIG_ADMIN_START  0x08007C00
#define DAPLINK_ROM_CONFIG_ADMIN_SIZE   0x00000400
#endif

#ifdef  STLINK_V2_1_BOOTLOADER
#define DAPLINK_ROM_IF_START            0x08004000
#define DAPLINK_ROM_IF_SIZE             0x0001B000
#else
#define DAPLINK_ROM_IF_START            0x08008000
#define DAPLINK_ROM_IF_SIZE             0x00017000
#endif

#define DAPLINK_ROM_CONFIG_USER_START   0x0801F000

...
//    }
//			   GPIOx->MODER == 0x00000002<<((pin_bit)&2);
//			   GPIOx->OTYPER == 0x00000001<<(pin_bit);
//			   GPIOx->OSPEEDR == 0x00000003<<((pin_bit)&2);
...
//    nRESET_PIN_PORT->BSRR = nRESET_PIN;
    ...
    SWCLK_TCK_PIN_PORT->BSRR = SWCLK_TCK_PIN;
    // Set SWDIO HIGH
		GPIO_InitStruct.Pin = SWDIO_OUT_PIN;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    HAL_GPIO_Init(SWDIO_OUT_PIN_PORT, &GPIO_InitStruct);
    SWDIO_OUT_PIN_PORT->BSRR = SWDIO_OUT_PIN;
    ...
    SWDIO_IN_PIN_PORT->BSRR = (((uint32_t)0x01) << SWDIO_IN_PIN_Bit); //chettan
    //HAL_GPIO_Init(SWDIO_IN_PIN_PORT, SWDIO_IN_PIN_Bit); 
    ...
    GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    HAL_GPIO_Init(nRESET_PIN_PORT, &GPIO_InitStruct);
    //HAL_GPIO_Init(nRESET_PIN_PORT, nRESET_PIN_Bit);//TODO - fix reset logic
    nRESET_PIN_PORT->BSRR = nRESET_PIN;
}
...
__STATIC_FORCEINLINE void PIN_SWDIO_OUT_DISABLE(void)
{
    ...
    HAL_GPIO_Init(SWDIO_OUT_PIN_PORT, &GPIO_InitStruct);
    SWDIO_OUT_PIN_PORT->BSRR = SWDIO_OUT_PIN;
	  //SWDIO_OUT_PIN_PORT->BSRR = (((uint32_t)0x01) << SWDIO_OUT_PIN_Bit);
}

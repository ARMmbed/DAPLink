...
#else
__inline static void protected_and (uint32_t *addr, uint32_t val) { *addr &= val; }
__inline static void protected_or  (uint32_t *addr, uint32_t val) { *addr |= val; }
__inline static void protected_xor (uint32_t *addr, uint32_t val) { *addr ^= val; }
#endif
/*

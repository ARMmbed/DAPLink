...
// Bootloader supported on HIC
COMPILER_ASSERT(DAPLINK_ROM_BL_START == DAPLINK_ROM_START);
COMPILER_ASSERT(DAPLINK_ROM_BL_START + DAPLINK_ROM_BL_SIZE == DAPLINK_ROM_IF_START);
COMPILER_ASSERT(DAPLINK_ROM_IF_START + DAPLINK_ROM_IF_SIZE == DAPLINK_ROM_CONFIG_ADMIN_START);
COMPILER_ASSERT(DAPLINK_ROM_CONFIG_ADMIN_START + DAPLINK_ROM_CONFIG_ADMIN_SIZE == DAPLINK_ROM_CONFIG_USER_START);
COMPILER_ASSERT(DAPLINK_ROM_CONFIG_USER_START + DAPLINK_ROM_CONFIG_USER_SIZE == DAPLINK_ROM_START + DAPLINK_ROM_SIZE);
#else
// Bootloader not supported on HIC
COMPILER_ASSERT(DAPLINK_ROM_IF_START == DAPLINK_ROM_START);
